...
");
		...
		<tr>
			...
			<td>
				...
				<a class="btn btn-sm btn-danger onclick="return confirm('Anda yakin menghapusnya')" title="Hapus" href="?menu=hapus_pasok&id_pasok=<?php echo $data['id_pasok']; ?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
