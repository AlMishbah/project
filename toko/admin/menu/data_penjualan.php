...
");
		...
		<tr>
			...
			<a class="btn btn-sm btn-danger onclick="return confirm('Anda yakin menghapusnya')" title="Hapus" href="?menu=hapus_jual&id_jual=<?php echo $data['id_jual']; ?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
				|
